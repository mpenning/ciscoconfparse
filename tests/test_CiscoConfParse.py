...
def testValues_HDiff_ios_unified_diffs_contents_01():
    """Test case for ios unified_diffs_contents()"""
...
-  switchport trunk native vlan 800
 ...
 interface Ethernet109/1/4
   switchport mode trunk
   switchport trunk native vlan 800
   spanning-tree port type edge""".splitlines()
...
def test_ios_blank_line_01():
    ...
    TEST_CONFIG = """service timestamps log datetime msec show-timezone
...
enable secret 5 $2$Ps80p.E2cxVbWWS2J5v9
ip subnet-zero
!
!
...
!
! global udld aggressive on all ports
udld aggressive
!
...
interface GigabitEthernet1/2
 ...
 switchport mode trunk
 switchport trunk allowed vlan 1-1102
