# -*- coding: utf-8 -*-
#
# ciscoconfparse documentation build configuration file, created by
...
copyright = u"2007-%s, %s" % (
    time.strftime("%Y"),
    ciscoconfparse.ciscoconfparse.__author__,
)
...
latex_documents = [
    (
        "index",
        "ciscoconfparse.tex",
        u"ciscoconfparse Documentation",
        u"David Michael Pennington",
        "manual",
    ),
]
