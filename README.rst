...
.. image:: https://static.pepy.tech/badge/ciscoconfparse
...
`Travis CI project <https://travis-ci.org>`_ tests ciscoconfparse on Python versions 2.7 through 3.8, as well as a `pypy JIT`_ executable.
